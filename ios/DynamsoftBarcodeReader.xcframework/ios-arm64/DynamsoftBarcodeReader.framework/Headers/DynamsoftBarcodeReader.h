...
typedef NS_ENUM(NSInteger, EnumErrorCode) 
{
    ...
    EnumErrorCode_IMAGE_ORIENTATION_INVALID      = -10063,
    
    /**The directory is invalid. */
    EnumErrorCode_DIRECTORY_INVALID              = -10064,
...
typedef NS_OPTIONS(NSInteger , EnumBarcodeFormat2)
{
    ...
    EnumBarcodeFormat2ALL                    = 0xFFFFFFFF
};
...
@property (nonatomic, nullable) NSString* barcodeFormatString_2 DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release.");
...
/**
* Convert the iImageData object to a UIImage.
*
...
* @return An UIImage that converted from the iImageData.
*
* @par Code Snippet:
* @code
     NSError *error;
 ...
 */
DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -DBRTextResultListener instead")
 ...
 */
DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -DBRIntermediateResultListener instead")
 ...
 */
DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -DBRLicenseVerificationListener instead")
 ...
 * Protocol for a delegate to handle callback when license verification message returned.
 */
DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -initLicense instead. Use -DBRLicenseVerificationListener instead")
 ...
 * @param [in,out] listener DBRLicenseVerificationListener.
 *
 * @par Code Snippet:
 * @code
     [DynamsoftBarcodeReader initLicense:@"Put your license here" verificationDelegate:self];
...
+ (void)initLicense:(nonnull NSString *)license verificationDelegate:(nonnull id<DBRLicenseVerificationListener>)listener NS_SWIFT_NAME(initLicense(_:verificationDelegate:));
  ...
  * @endcode
  */
- (instancetype _Nonnull)initWithLicense:(NSString* _Nonnull)license DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -initLicense:verificationDelegate: instead");
...
- (instancetype _Nonnull)initWithLicenseFromServer:(NSString* _Nullable)licenseServer
                              ...
                              verificationDelegate:(id _Nullable)connectionDelegate DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -initLicense:verificationDelegate: instead");
 ...
 * @endcode
 */
-(NSString *_Nullable)getModeArgument:(NSString* _Nonnull)modeName
                               index:(NSInteger)index
                        argumentName:(NSString* _Nonnull)argumentName
                               error:(NSError* _Nullable * _Nullable)error;
...
- (NSArray<iTextResult*>* _Nullable)decodeIntermediateResults:(NSArray<iIntermediateResult*>* _Nullable)array
                                                 withTemplate:(NSString* _Nonnull)templateName
                                                        error:(NSError *_Nullable *_Nullable)error NS_SWIFT_NAME(decodeIntermediateResults(_:templateName:)) DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -decodeIntermediateResults:error: instead");
...
- (NSArray<iTextResult*>* _Nullable)decodeBase64:(NSString* _Nonnull)base64
                                    withTemplate:(NSString* _Nonnull)templateName
                                           error:(NSError* _Nullable * _Nullable)error DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -decodeBase64:error: instead");
/**
 * Decodes barcodes from an image file encoded as a base64 string.
 *
 * @param [in] base64 A base64 encoded string that represents an image.
...
- (NSArray<iTextResult*>* _Nullable)decodeImage:(UIImage* _Nonnull)image
                                   withTemplate:(NSString* _Nonnull)templateName
                                          error:(NSError* _Nullable * _Nullable)error NS_SWIFT_NAME(decodeImage(_:templateName:)) DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -decodeImage:error: instead");
...
- (NSArray<iTextResult*>* _Nullable)decodeBuffer:(NSData* _Nonnull)buffer
                                    ...
                                    templateName:(NSString* _Nonnull)templateName
                                           error:(NSError* _Nullable * _Nullable)error DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -decodeBuffer:withWidth:height:stride:format:error: instead");
...
- (NSArray<iTextResult*>* _Nullable)decodeFileWithName:(NSString* _Nonnull)path
                                          templateName:(NSString* _Nonnull)templateName
                                                 error:(NSError* _Nullable * _Nullable)error NS_SWIFT_NAME(decodeFileWithName(_:templateName:)) DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -decodeFileWithName:error: instead");
 ...
 * @endcode
 */
-(void)setDBRTextResultDelegate:(id _Nullable)textResultDelegate userData:(NSObject* _Nullable)userData DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -setDBRTextResultListener: instead");
 ...
 * @endcode
 */
-(void)setDBRIntermediateResultDelegate:(id _Nullable)intermediateResultDelegate userData:(NSObject* _Nullable)userData DEPRECATED_MSG_ATTRIBUTE("Will be removed in dbr10.0 release. Use -setDBRIntermediateResultListener: instead");
...
@property (nonatomic, assign) NSInteger minImageReadingInterval;
